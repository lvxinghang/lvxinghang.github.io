...
>
>   <img src="../assets/img/Android软件安全/dx.png" style="zoom: 80%;" />
>
> * 虚拟机架构不同
>
>   java: 基于`栈架构`。
...
>   Dalvik: 基于`寄存器架构`。
>
>   ![](../assets/img/Android软件安全/JVM.png)
>
>   iload_1：i表示int类型，load表示将局部变量存入Java栈，1表示要操作的哪个局部变量。
>
>
>
>   ![](../assets/img/Android软件安全/Dalvik虚拟机运行状态.png)
>
>
>
...
>>
>>![image-20201118204814451](../assets/img/Android软件安全/LEB128.png)
>>
...
>>****
>>
>>* <img src="../assets/img/Android软件安全/DexHeader.png" alt="image-20201118210432967" style="zoom: 80%;" />
...
>>****
>>
>>* ![image-20201118212018729](../assets/img/Android软件安全/DexCode.png)
...
>>* <img src="../assets/img/Android软件安全/OAT.png" alt="image-20201118212018729" style="zoom:67%;" />
>>
>>**将OAT文件转换成DEX文件**
>>
